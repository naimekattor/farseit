...
const About = () => {
  ...
  return (
    <div id='about' className='flex items-center bg-[#0b3252] py-[80px] px-[30px]'>
      ...
      <motion.div
        ...
        className='w-1/2 text-justify p-8'>
